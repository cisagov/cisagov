...
issue](https://github.com/cisagov/cisagov/issues) in this
...
request](https://github.com/cisagov/cisagov/pulls), you will
...
```console
cd cisagov
pyenv virtualenv <python_version_to_use> cisagov
pyenv local cisagov
